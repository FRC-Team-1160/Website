...
<!--GOOGLE WAS STUPID, MOST WEBSITES SAY TO PUT THESE IN THE HEAD...-->

			<!--MAIN STYLES-->
			<link property="stylesheet" rel="stylesheet"	type="text/css"	href="<?php bloginfo('stylesheet_url'); ?>?ver=3.6.10.7" />
			<!--end MAIN STYLES-->
