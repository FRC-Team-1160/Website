			...
			?>
					...
					<div class="post columned">
						<div class="post-content">
							<div class="entry">
<?php // FEATURED IMAGE ?>
								<a href="#<?php sanitize_title_with_dashes( the_title() ) ?>" rel="link" title="Link to <?php the_title(); ?>">
			...
			?>
						...
						<div class="entry profile" id="<?php sanitize_title_with_dashes( the_title() ) ?>">
